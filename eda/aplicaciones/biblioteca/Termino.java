...
public class Termino {
    ...
    public int hashCode() { 
        ...
        // COMPLETAR (HECHO): calcular el valor de res para this.termino en this.baseHashCode
    ...
    public boolean equals(Object obj) {
        Termino p= (Termino)obj;
        if(this.valorHash == valorHash){
            return p.termino.equals(this.termino);
        }
        return false;
    }
